...
function RegisterMotherModal({ children }: { children: ReactElement }) {
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[650px] ">
        <DialogHeader>
          ...
          <DialogDescription>
            Register a new mother. Enter the required details and click Create
            to create the admin.
          </DialogDescription>
        </DialogHeader>
...
export default RegisterMotherModal;
