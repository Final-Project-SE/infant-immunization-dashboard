...
import { Child, ChildOfMother } from "@/utils/types/component";
import {
  DeleteChildAction,
  UpdateChildAction,
  ViewDetailAction,
...
//column definitions...
const columns: MRT_ColumnDef<ChildOfMother>[] = [
  {
    enableSorting: false,
    enableEditing: false,
...
const ChildrenByMotherTable = ({ children }: { children: ChildOfMother[] }) => {
  return (
    <Table
...
export default ChildrenByMotherTable;
